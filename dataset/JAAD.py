...
from dataset.JAAD_origin import JAAD
from . import transforms as T
from SC_MSF.utils.dataset_utils import bbox_to_goal_map
import copy
import glob
import time
import pdb
...
class JAADDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        obd_speed = torch.FloatTensor(self.data['vehicle_act'][index])
...
##########################################################处理光流信息
    ...
    def get_data(self, data, **model_opts):
        ...
        ret =  {'obs_image': obs_slices['image'],
                ...
                'vehicle_act': obs_slices['vehicle_act']
                }
