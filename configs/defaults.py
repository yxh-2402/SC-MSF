...
_C.CKPT_DIR = 'checkpoints/JAAD'
_C.OUT_DIR = 'outputs/JAAD'
_C.DEVICE = 'cuda'
_C.METHOD = 'JAAD'
_C.GPU = '0'
_C.VISUALIZE = False
...
_C.DATASET.ROOT = 'data/JAAD'
_C.DATASET.TRAJECTORY_PATH = 'data/JAAD/trajectories'
_C.DATASET.FPS = 30
...
_C.SOLVER.PLATEAU_FACTOR = 0.2
_C.SOLVER.PLATEAU_PATIENCE = 5
_C.SOLVER.MIN_LR = 1e-7
_C.SOLVER.MILESTONES = [25, 40]
